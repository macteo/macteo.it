(function () {
   ...
   * @param {String} [options.dotImage = this.template.commit.dot.image]
   *
  ...
  function Commit ( options ) {
    ...
    this.dotImage = options.dotImage || this.template.commit.dot.image;
  ...
  Commit.prototype.render = function () {
    ...
    if ( this.dotImage ) {
      ...
      var strokeWidth = this.dotStrokeWidth;
      img.onload = function(){
        ctx.save();
        ctx.beginPath();
        ...
        ctx.drawImage(img, x - dotSize, y - dotSize, dotSize * 2, dotSize * 2);
        ctx.restore();
      };
      img.src = this.dotImage;
    }
   ...
   * @param {String} [options.commit.dot.image] - Commit dot fill image url
  ...
  function Template ( options ) {
    ...
    this.commit.dot.image = options.commit.dot.image || null;
